			...
			<div class="card">
				<div class="card-header">
					<ul class="nav nav-tabs card-header-tabs" id="myTab" role="tablist">
						<li class="nav-item">
							<a class="nav-link active" id="posts-tab" data-toggle="tab" href="#posts" role="tab" aria-controls="posts" aria-selected="true"><?php echo $args['title_reply']; ?></a>
						</li>
					</ul>
				</div>
				<div class="card-body">
					...
					<div class="text-end pt-2">
						<button type="submit" class="btn btn-primary"><?php echo $args['label_submit']; ?></button>
					</div>
				</div>
			</div>
